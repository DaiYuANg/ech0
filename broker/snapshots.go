...
func (b *Broker) topicSummary(topic store.TopicConfig) (TopicSummary, error) {
	summary := TopicSummary{
		...
		PriorityPolicy:                 topicPriorityPolicyName(topic.PriorityPolicy),
		PriorityMin:                    topic.PriorityPolicy.Min,
		PriorityMax:                    topic.PriorityPolicy.Max,
		PriorityDefault:                topic.PriorityPolicy.Default,
